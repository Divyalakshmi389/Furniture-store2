...
<body>
	<div class = "container">
	 	<div class="row">
	 		<div class="col-md-12">
                <h2 class="display-3"><font color="blue">Checkout</font>h2>
                <div class="row">
					<div class="col">
                		<a href="/furniture/cart" class="btn btn-primary btn-md">Return to Shopping Cart</a>
            ...
            <div class="col-md-12">
            	<form action="#" th:action="@{/furniture/processPayment}" method="POST">
				   ...
				   <div class="row">
		 			...
		 			<div class="form-group">
		 			 ...
		 			 <div class="col-md-12 text-center">
			 			 ...
			 			 <a href="/furniture/products" class="btn btn-light col-2">Cancel</a>
		 			 </div>
				</form>
            </div>
		</div>
