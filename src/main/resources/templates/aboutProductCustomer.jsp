...
<body>
	<div class="container">
		<h1 class="display-4"><b><font color="blue">Product Detail</font></b></h1>
		<p class="h4">Here is the detail information of the product!</p>
		<hr class="featurette-divider">
		
		<h4 class="display-4" th:inline="text">[[${res.title}]]
			<a class="btn btn-warning" th:href="@{//addProductToCart(productId=${res.pid})}" onclick="(alert('Product successfully added to the cart!!!'))" role="button">Add to Cart</a>
		</h4>
