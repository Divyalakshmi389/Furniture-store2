...
<body>
	<div class="container">
		<h1 class="display-3"><font color="blue"><b>PRODUCTS</b></font></h1>
			...
			<div class="col-10">
				<div class="dropdown">
				  ...
				  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
				    <a class="dropdown-item" href="/admin/addNonPremium">NonPremium</a>
				    <a class="dropdown-item" href="/admin/addPremium">Premium</a>
				  </div>
				</div>
			</div>
			<div class="col">
