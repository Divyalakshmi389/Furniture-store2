...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="display-4"><font color="blue"><b>My Shopping Cart</b></font></h2>
			...
			<div class="col-md-2">
				<a class="btn btn-danger btn-md" th:href="@{/furniture/deleteCartItems}" 
				role="button" 
                ...
                <table class="table table-bordered table-striped table-light table-hover text-center">
                        ...
                        <tbody>
							<tr th:each="r : ${results}">
					           ...
					           <td>
					           	<a th:href="@{/furniture/deleteCartItem(cartId=${r.cid}, productId=${r.pid})}" class="btn btn-danger btn-sm"
            ...
            <div class="col-md-12">
                <div class="pull-right">
                    <a href="/furniture/products" class="btn btn-light btn-md">Continue Shopping</a>
                    <a href="/furniture/paymentInfo" class="btn btn-primary btn-md">Checkout</a>
                </div>
                 <hr class="featurette-divider">
            </div>
        </div>
    ...
    <div class="row">
		...
		<div class="col">
			<a class="btn btn-primary" href="/furniture/products" role="button">Back</a>
