...
<body>
	<div class="container">
		<h1 class="display-4"><b><font color="blue">All Products</font></b></h1>
		<p>Checkout all the awesome products available now!</p>
		<hr class="featurette-divider">
		<div class="row">
			<div class="col-10"></div>
			<div class="col">
				<a class="btn btn-primary btn-md" href="/furniture/cart" role="button">Shopping Cart</a></br>
			</div>
		</div>
		<hr class="featurette-divider">
		...
		<table id="example"  class="table table-bordered table-striped table-light table-hover">
			...
			<tbody>
				<tr th:each="r,state : ${results}">
		           ...
		           <td>
		           	<a th:href="@{/furniture/aboutProduct(productId=${r.pid})}" class="btn btn-outline-info btn-sm">Info</a>	
           		  </td>
			     </tr>
			</tbody>
		</table>
